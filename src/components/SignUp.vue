<template>
    ...
    <img src="../assets/logo.webp" width="500px" height="500px">
    <div class="register">
        <form class="form">
            <div class="title">Welcome,<br><span>Sign up to Spend Your Fortune</span></div>
            <input class="input" v-model="username" placeholder="Name" type="text">
            ...
            <button class="button-confirm" v-on:click="signUp">Let`s go →</button>
            <p class="title">Already a member? <br> <router-link to="/logIn">Log In</router-link> Then</p>
            <p class="title">Boss? Is this you? <br> <router-link to="/adminlogin">Yes</router-link> </p>
        </form>
    </div>
...
export default {
    ...
    methods:{
      async signUp(){
        await axios.post("https://localhost:5001/User/Register", {
