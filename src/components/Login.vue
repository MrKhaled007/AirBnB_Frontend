<template>
    ...
    <div class="register">
        <form class="form">
            <div class="title">Welcome,<br><span>Log In</span></div>
            ...
            <button class="button-confirm" v-on:click="log">Log In →</button>
            <p class="title">No existing Account? <br> <router-link to="/sign-up">Sign Up</router-link> Then</p>
