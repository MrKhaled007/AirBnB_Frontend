<template>
  <!-- Only For Designing Purpose Use of Tailwind-->
    <img src="../assets/logo.webp" width="500px" height="500px">
    <div class="register">
        <form class="form">
            <div class="title">Then Prove It!</div>
            ...
            <button class="button-confirm" v-on:click="log">Log In →</button> <!--Sending to the method-->
            <p class="title">No I am not the Boss. Sorry for invading <br> <router-link to="/sign-up">Go to Sign Up</router-link> Then</p>
    ...
    methods: {
        async log() {
            if (this.email === 'Admin' && this.password === 'Admin') {
                ...
                return;
                //I can add more admins by just adding more hard coded credentials
            }
